<template>
  <div>
    <nav class="leftmen">
      <div class="leftmen-h">
        <h2 class="vex" style="margin-right:5px;" @click="this.$router.push('/admin');">Estate</h2>
        <p class="vex">Admin</p>
        <button class="tbtn" @click="changeTheme()" type="button" style="margin-left:5px;">
          <svg
            id="dark"
            style="display: block;"
      ...
      <div class="navr">
        <ul>
          <li @click="this.$router.push('/admin');">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
          ...
          <li @click="this.$router.push('/admin/ilanlar');">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
          ...
          <li @click="this.$router.push('/admin/ilan-ekle');">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
          ...
          <li @click="this.$router.push('/admin/kullanicilar');">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
          ...
          <li onclick="window.location.href = '/logout'" class="btr"> 
            <svg width="20" height="20">
              <use :xlink:href="svgLocation + '#logOut'" />
            </svg>
            Çıkış
          </li>
        </ul>
    ...
    <main class="mvp-90 center" style="padding-left:191px">
      <br />
